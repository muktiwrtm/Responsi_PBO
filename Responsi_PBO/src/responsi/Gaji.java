...
class Gaji extends JFrame {
    ...
    static final String DB_URL = "jdbc:mysql://localhost/gaji_java";
    ...
    JButton btnRefershPanel = new JButton("Hitung");
...
//        add(lGambar);
        ...
        add(btnRefershPanel);
        btnRefershPanel.setBounds(200,300,100,50);
        add(btnCreatePanel);
        btnCreatePanel.setBounds(350,300,100,50);
...
public void insertPegawai(String id, String nama, String posisi, String alamat, String hp, long gaji, long jam, long tunjangan, long pajak, long total) {
